# gtarp_tips — anonymous payphone tips

Snitching as a scene. `/tip [what you saw]` works only within reach of
a real payphone — the tip lands on the police 911 log (`gtarp_mdt`
...
- Tips land via `gtarp_mdt`'s additive `LogCall` export — this resource
