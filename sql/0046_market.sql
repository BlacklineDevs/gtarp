-- 0046_market.sql — gtarp_market (Palm6 Commodity Exchange)
-- Server-authoritative supply/demand market for gtarp_grind raw goods.
-- Prefixed `gtarp_` per the table-naming convention (post gtarp_housing incident).
